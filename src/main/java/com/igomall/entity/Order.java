...
public class Order extends BaseEntity<Long> {
	...
	public BigDecimal getAmountPayable() {
		if (!hasExpired() && !Status.COMPLETED.equals(getStatus()) && !Status.FAILED.equals(getStatus()) && !Status.CANCELED.equals(getStatus()) && !Status.DENIED.equals(getStatus())) {
	...
	public BigDecimal getAmountReceivable() {
		if (!hasExpired() && PaymentMethod.Type.CASH_ON_DELIVERY.equals(getPaymentMethodType()) && !Status.COMPLETED.equals(getStatus()) && !Status.FAILED.equals(getStatus()) && !Status.CANCELED.equals(getStatus()) && !Status.DENIED.equals(getStatus())) {
	...
	public int getShippableQuantity() {
		if (!hasExpired() && Status.PENDING_SHIPMENT.equals(getStatus())) {
	...
	public boolean canDelete() {
		return Status.CANCELED.equals(getStatus()) || Status.FAILED.equals(getStatus()) || Status.DENIED.equals(getStatus());
	}
